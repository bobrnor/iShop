...
# Database: ishop
# Generation Time: 2012-04-07 19:01:55 +0000
# ************************************************************
...
VALUES
	(1,'Bravo-07','bravo-07.png',2700,1,'???????? ??????? ???? ?? ???? - Bravo! ??? ?????? ?????????, ???? ? ???????? ?????? ?? ????? ?????????? ????????'),
	(2,'Dynamite-03','Dynamite-03.png',3100,1,'????? ?? ?????????. ????????????? ????, ?? ???????, ? ????????? ???????? ????????? ? ???? ??????. ?????? ????????? 13 ??.'),
	(3,'stomp-101','stomp-101.png',5600,3,'?????? ?? ???????? ?????????. ????????????? ????, ?? ????????, ? ????????????? ???????? ? ?????????. ?????? ????????? 12 ??.'),
